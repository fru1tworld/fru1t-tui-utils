...
오늘 배운 내용을 날짜별로 쌓는 Rust 터미널 메모장입니다. todo-tui와 같은
...
최초 데이터베이스를 만들 때 2026-08-31 날짜의 예시 TIL을 한 번만 추가합니다.
이후 사용자가 수정하거나 삭제한 샘플을 다시 덮어쓰지 않습니다.
